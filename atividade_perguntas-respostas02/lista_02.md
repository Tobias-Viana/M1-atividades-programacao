...
Receber valor_total_da_compra

Se o valor_total_da_compra < 50
    Exibir "Frete não disponível!"

Senão: 
    o valor_total_da_compra >= 50 E valor_total_da_compra <= 199.99
...
velocidadeInicial <- entrada do usuário
velocidadeSegura <- entrada do usuário
desaceleracao <- entrada do usuário
tempoMáximo <- entrada do usuário
tempo <- 0
...
Senão:
    Exibir "Falha: Tempo máximo atingido antes de alcançar velocidade segura."
...
Função MultiplicarMatrizesInvestimento(matrizA, matrizB):
    # Verifica se o número de colunas da matrizA é igual ao número de linhas da segunda matriz
    Se tamanho colunas(matrizA) ≠ tamanho linhas(matrizB) então:
        Retornar "As matrizes não podem ser multiplicadas. Dimensões incompatíveis."

    linhasResultado <- tamanho linhas(matrizA)
    colunasResultado <- tamanho colunas(matrizB)
    matrizResultado <- novaMatriz(linhasResultado, colunasResultado)
     ...
     Para i de 0 até linhasResultado-1 faça:
        Para j de 0 até colunasResultado-1 faça:
            ...
            Para k de 0 até tamanho colunas(matrizA)-1 faça:
